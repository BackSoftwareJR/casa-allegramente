...
export default function Privacy() {
  return (
    <>
      <Helmet>
        <title>Informativa sulla privacy — Il Castagno</title>
        <meta
          name="description"
          content="Informativa sulla privacy di Il Castagno, casa famiglia per anziani a Bedero Valcuvia (VA)."
        />
      </Helmet>

      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        <h1 className="font-serif text-3xl text-castagno-forest sm:text-4xl">Informativa sulla privacy</h1>
